...
CREATE TABLE `playlistsongs` (
  ...
  KEY `sid2` (`songID`),
  KEY `pid` (`playlistID`),
  CONSTRAINT `pid` FOREIGN KEY (`playlistID`) REFERENCES `playlists` (`playlistID`),
  CONSTRAINT `sid2` FOREIGN KEY (`songID`) REFERENCES `songs` (`songID`)
...
INSERT INTO `playlistsongs` VALUES (1,1),(1,5),(1,7),(1,2),(1,9);
